...
/*
In this question, we will design the class Students to manage the scores. There are N(=10) students. Each student has a student’s ID, name, and 3 scores. In this program, you need to print out all students with the descending order of total scores. Also, you need to provide a function to find the student who has a certain ID(this value will be asked to the user). In this search function, you should use the binary search algorithm to find the student. 
